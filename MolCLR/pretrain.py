...
class MolCLR(object):
    ...
    def train(self):
        ...
        if self.config['model_type'] == 'gin':
            from models.ginet_molclr_modified import GINet
...
def main():
    ...
    if config['aug'] == 'node':
        from dataset.dataset_modified import MoleculeDatasetWrapper
    ...
    dataset = MoleculeDatasetWrapper(config['batch_size'], config['seed'], **config['dataset'])
